...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-black w-full !text-white pt-10 overflow-hidden border-0 shadow-none">
  {/* GRADIENT */}

  <div className="w-full max-w-6xl mx-auto flex flex-col lg:flex-row gap-12 !text-white items-start justify-between px-6 md:px-10 xl:px-0">
    {/* Left Section */}
  ...
  <div className="absolute container inset-0 pointer-events-none overflow-hidden" />
  <div className="absolute bottom-0 right-0 h-20 lg:h-28 w-10/12 lg:w-1/4 bg-[#CE17F8] blur-[120px] z-0"></div>
  <div className="absolute -top-10 right-0 h-20 lg:h-28 w-10/12 lg:w-1/4 bg-[#CE17F8] blur-[100px] z-0"></div>
  <div className="absolute bottom-0 left-0 h-20 lg:h-28 w-10/12 lg:w-1/4 bg-[#7500FF] blur-[120px] z-0"></div>
  <div className="absolute -top-10 left-1/2 h-20 lg:h-28 w-10/12 lg:w-1/4 bg-[#0009FF] blur-[100px] z-0"></div>
  <div className="absolute -top-10 left-0 h-20 lg:h-28 w-10/12 lg:w-1/4 bg-[#7500FF] blur-[100px] z-0"></div>

  <div className="flex flex-col md:flex-row gap-3 justify-center md:justify-between items-center max-w-6xl mx-auto">
    <div className="border-t-2 border-white"></div>
    <div className="w-full text-white text-sm mt-10 py-6 text-center md:text-start">
