...
const ArticleWriter = () => {
  ...
  return (
    <div className="relative w-full py-4 px-4 ">
             ...
             <div className="absolute bottom-1/4 left-1/2 h-20 lg:h-28 w-10/12 lg:w-1/4 bg-[#7500FF] blur-[120px]"></div>
             <div className="absolute top-0 right-0 h-20 lg:h-28 w-10/12 lg:w-1/4 bg-[#0009FF] blur-[120px]"></div>
             <div className="absolute top-[40%] right-0 h-20 lg:h-28 w-10/12 lg:w-1/4 bg-[#0009FF] blur-[120px]"></div>

      <div className="w-full max-w-6xl mx-auto flex flex-col gap-6 items-center justify-center">
          ...
          <div className="relative backdrop-blur-lg p-4 md:p-6 lg:p-8">
            ...
            >
              ...
              <div className="flex-1 space-y-7 !text-white">
                <button className="gradient-border-wrapper px-8 py-2 rounded-full font-semibold text-white hover:text-white flex items-center shadow-lg hover:shadow-purple-500/20">
      ...
      <li key={item.id} className="flex items-start gap-3">
        ...
        <p className="text-white/90 text-sm md:text-base lg:text-lg leading-relaxed">
          {item.listItem}
                ...
                >
                  <button className="inline-flex items-center bg-[#7E3BFF] hover:bg-[#7E3BFF]/50 mt-8 px-4 py-1 lg:px-6 lg:py-3 rounded-3xl text-white/90 hover:text-white transform transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl font-semibold">
                  Write Your First Article for Free             
                  </button>
                </Link>
              </div>
