...
const SeoContentCreation = () => {
  return (
    <main className="relative w-full max-w-[1240px] px-4 md:px-6 xl:px-0  pt-20 py-10 md:pt-36 md:py-16 lg:py-20 lg:pt-40 h-full flex flex-col gap-10 lg:gap-20 justify-start items-center z-10 ">
