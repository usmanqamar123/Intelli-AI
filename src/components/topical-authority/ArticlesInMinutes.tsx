...
const ArticlesInMinutes = () => {
  return (
    <main className="relative w-full max-w-[1240px] px-4 md:px-6 xl:px-0 font-geist pt-20 py-10 md:pt-36 md:py-12 lg:pt-40 h-full font-geist flex flex-col gap-10 lg:gap-20 justify-start items-center z-10 mx-auto ">
      ...
      <div className="flex flex-col place-items-center gap-2">
        <div className="max-w-3xl leading-normal text-3xl md:text-4xl lg:text-5xl font-bold tracking-normal text-white text-center">
          Publish {""}
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {ArticlesInMinutesData.map((items, index) => (
          <div
            key={index}
            className="w-full gradient-border-wrapper rounded-2xl p-[1.25px]"
          >
            <div className="w-full p-6 bg-transparent bg-blend-exclusion h-[200px] rounded-2xl">
