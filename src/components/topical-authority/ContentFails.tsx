...
const ContentFails = () => {
  return (
    <main className="relative w-full max-w-[1240px] px-4 md:px-6 xl:px-0 h-full py-10 lg:py-20 flex flex-col gap-10 lg:gap-20 justify-start items-center z-10 mx-auto ">
