...
import { MoretoolsALL, stepsImage } from "@/constants/index";
import Image from "next/image";
import Link from "next/link";
import React from "react";
import { imagegene } from "../../../public";
import Button from "@/components/Button";

const ExcludedTitle = "Image Generator"; // Specify the title to exclude
...
const page = () => {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center my-16">
      <div className="w-full h-full hero-section flex px-2 justify-center items-center flex-col">
        <div className="max-w-[1400px] container mx-auto md:px-0 py-20 flex flex-col lg:flex-row items-center justify-center">
          <div className="w-full lg:w-1/2 text-white flex flex-col mx-10 justify-between gap-3">
            <h1 className="text-3xl md:text-5xl mx-5 lg:mx-0 font-semibold capitalize w-[90%] xl:w-[85%] lg:text-start text-center">
              <span>
                AI <span className="gradient-span-1">Image</span> Generator
              </span>
            </h1>
            <p className="text-sm md:text-lg mx-5 lg:mx-0 my-4 w-[90%] text-center lg:text-start">
              ...
              artistic expression. Whether you&apos;re a blogger, social media
              marketer, or seeking to infuse creativity into your projects, our
            ...
            <div className="w-fit mx-auto lg:mx-0 justufy-center lg:justify-start text-center lg:text-left">
              <Link
                href={
                  tokens
                    ? `${process.env.NEXT_PUBLIC_APP}user/image-generator`
          ...
          <div className="w-full lg:w-1/2 pt-5 md:pt-5 lg:pt-0 flex justify-center">
            <Image
              ...
              height={320}
              priority={true}
              className="md:w-full md:h-full z-10  rounded-2xl"
            />
          </div>
        </div>
      </div>

      <div className="max-w-[1400px] xl:px-16 px-2 justify-center items-center md:px-6  py-10 text-white  flex flex-col items- justify ">
        <div className="py-10">
          ...
          <p className="md:text-[21px] text-[16px] font-[500] leading-[36px] !text-white lg:px-10 md:p-6 p-4">
            Embark on an unstoppable journey of creativity with our AI Image
            Generator – where your text come to life with captivating AI images
      ...
      <div className="max-w-[1400px] reason xl:px-16 px-2 justify-center items-center md:px-6  py-10 mt-8 text-white flex flex-col">
        <div className="py-10">
      ...
      <div className="border border-[#554869] w-full h-72 bg-gradient-to-br from-[#201634] to-[#643cba8a] relative  my-16 flex items-center justify-center">
        <div className="absolute top-24 w-full flex flex-col items-center justify-center z-10">
          <p className="text-center text-xl md:text-4xl text-white">
            ...
            <span className="gradient-span-1">AI Image </span> now
          </p>
          <div className="mt-4">
            <Link
              href={
