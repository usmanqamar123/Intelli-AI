...
import { MoretoolsALL, dataBlog, stepsBlog } from "@/constants/index";
import Image from "next/image";
import Link from "next/link";
import React from "react";
import { blogcontent } from "../../../public";
import Button from "@/components/Button";

const ExcludedTitle = "Blog content"; // Specify the title to exclude
...
const page = () => {
  ...
  return (
    <div className="my-16  flex flex-col justify-center items-center ">
      <div className="h-full hero-section px-2 flex flex-col justify-center items-center">
        <div className="container mx-auto md:px-0 py-20 flex flex-col lg:flex-row items-center justify-center">
          <div className="w-full lg:w-1/2 text-white flex flex-col mx-10 justify-between gap-3">
            ...
            <p className="text-sm md:text-lg mx-5 lg:mx-0 my-4 w-[90%] text-center lg:text-start">
              ...
              efficiency, and even creativity that human wordsmiths alone
              can&apos;t match.
            </p>
            <div className="w-fit mx-auto lg:mx-0 text-center lg:text-left">
              <Link href={tokens ?`${process.env.NEXT_PUBLIC_APP}user/blog-content` : `${process.env.NEXT_PUBLIC_APP}auth/register`}>
      ...
      <div className="xl:px-16 md:px-6 px-4 py-10 text-white  flex flex-col self-center ">
        <div className="py-10">
          ...
          <p className="md:text-[21px] text-[16px] font-[500] leading-[36px] !text-white lg:px-10 md:p-6 p-4">
            ...
            power and impact of AI Blog Generator.
          </p>
        </div>
      </div>
      <div className="w-[90%] md:w-3/4 mx-auto grid grid-cols-1 self-center sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 py-5 ">
      ...
      <div className="container mx-auto px-4 flex flex-col self-center py-10 text-white">
        <div className="py-10">
      ...
      <div className="reason container self-center mx-auto px-4 py-10 mt-8 text-white flex flex-col">
        <div className="py-10">
          <h2 className="lg:text-6xl text-5xl font-normal relative lg:p-10 md:p-6 p-4 text-center lg:text-left">
            <span className="border-text text-white opacity-20 absolute top-0 lg:left-0">
              DISCOVER MORE
      ...
      <div className="mt-6 px-2 flex items-center justify-center self-center">
        <FAQs faqs={BlogContentFAQs} />
      </div>

      <div className="border border-[#554869] w-full h-72 self-center  bg-gradient-to-br from-[#201634] to-[#643cba8a] relative px-2 my-16 flex items-center justify-center">
