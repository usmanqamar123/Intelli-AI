...
import Loader from "@/components/SEO-Checker/Loader";
  ...
  const handleAnalyze = async (url: string) => {
    try {
      ...
      const res = await fetch(
        `https://dev.intelliwriter.io/sandbox/seo-checker/analyze`,
        {
          method: "POST",
          headers: {
    ...
    <Loader />
        ...
        analysisData && (
          <>
            ...
            />
            <SEOInsightsCTA />
            <MetaDataCoverageRadar meta_data={analysisData.meta_data} />

            <OnPageScore analysisData={analysisData} />
            <SeoAuditTable analysisData={analysisData} />
            {/* <Faq /> */}
          </>
        )
      )}
