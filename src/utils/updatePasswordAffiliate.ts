const updatePasswordAffiliate = async (passwordData: {
    oldPassword: string;
    newPassword: string
}): Promise<{
    success: boolean;
    ...
    try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/affiliate/update-password/${userId}`, {
            method: "PATCH",
            headers: {
...
export default updatePasswordAffiliate;
